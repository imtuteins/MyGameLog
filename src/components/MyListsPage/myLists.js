...
const MyLists=()=>{
    return(
        <div className="position-relative d-flex flex-column w-100 min-vh-100 " style={{background: 'rgb(21,17,34)', background: 'linear-gradient(94deg, rgba(21,17,34,1) 0%, rgba(45,12,55,1) 24%, rgba(28,20,77,1) 64%, rgba(14,7,24,1) 100%)', overflowX: 'hidden', fontFamily: "'Be Vietnam Pro', 'Noto Sans', sans-serif"}}>
            <div className="container-fluid d-flex justify-content-center h-100" style={{marginTop:'30px'}}>
                <h1 style={{marginTop:'70px'}} className='text-white text-center'>Mis Listas <br/>(Ruta Privada pero esta accesible en lo que se crea la validacion con BD) <br/> Coming Soon...</h1>
            </div>
        </div>
    )
}
