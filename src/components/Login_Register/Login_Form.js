        ...
        <Container style={{ maxWidth: '400px', marginTop: '10px', backgroundColor: '#2c2c54', padding: '20px', borderRadius: '10px', color: 'white' }}>
            ...
            <Form noValidate validated={validated} onSubmit={handleSubmit}>
                <Form.Group controlId="formBasicEmail">
                    ...
                    <Form.Control required type="text" style={{ backgroundColor: '#1e1e2f', color: 'white', border: 'none' }} value={username} onChange={(e)=> setUsername(e.target.value)}  />
                ...
                <Form.Group controlId="formBasicPassword">
                    ...
                    <InputGroup>
                        <Form.Control type={showPassword ? 'text': 'password'} required style={{ backgroundColor: '#1e1e2f', color: 'white', border: 'none' }} value={password} onChange={(e) => setPassword(e.target.value)} />
