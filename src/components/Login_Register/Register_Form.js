                ...
                <Form noValidate validated={valid} onSubmit={handleSubmit}>
                    ...
                    <Form.Group controlId="formBasicPassword">
                        <Form.Label>Password</Form.Label>
                            <InputGroup>
                                <Form.Control required type={showPassword ? 'text': 'password'} placeholder="Contraseña" style={{ backgroundColor: '#1e1e2f', color: 'white', border: 'none' }} value={password} onChange={(e) => setPassword(e.target.value)}/>
